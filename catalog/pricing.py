...
Uses Python 3.11 syntax: a `match` statement (PEP 634) for order-size
classification, and `typing.Self` (PEP 673) on OrderQuote.from_request so
the constructor's return type stays correct under subclassing.
"""
