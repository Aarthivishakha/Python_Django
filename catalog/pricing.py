...
Written for Python 3.4: no f-strings or variable annotations (both
added in 3.6) - %-style formatting is used instead.
"""
...
def classify_order_size(quantity):
    ...
    Plain if/elif - Python 3.4 has no match statement (added in 3.10).
    """
    if quantity <= 0:
        return 'invalid'
    elif quantity < 5:
